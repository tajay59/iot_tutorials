...
class MQTT:
    ...
    sub_topics = [("620012345_pub", 0), ("620012345", 0), ("620012345_sub", 0), ("620012345_radar", 0)] #  A list of tuples of (topic, qos). Both topic and qos must be present in the tuple.
    ...
    def __init__(self,mongo):
        ...
        self.client.message_callback_add("620012345_radar", self.radar)
    ...
    def radar(self, client, userdata, msg):
        try:
            topic   = msg.topic
            payload = msg.payload.decode("utf-8")
            print(payload) # UNCOMMENT WHEN DEBUGGING  
